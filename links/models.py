...
class URL(models.Model):
    ...
    new_url = models.CharField(max_length=10, unique=True, db_index=True, null=True, blank=True)
    ...
    @property
    def is_expired(self):
        return self.expires_at <= timezone.now() or (self.one_time_use and self.clicks > 0)
